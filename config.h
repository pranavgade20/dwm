...
static const char *audacious[]  = { "audacious" ,"--headless", NULL };
static const char *audacious_next[]  = { "audacious" ,"--fwd", NULL };
static const char *audacious_toggle[]  = { "audacious" ,"--play-pause", NULL };
...
static Key keys[] = {
        ...
        { MODKEY|ShiftMask,             XK_p,      spawn,          {.v = private_browser } },
        { MODKEY|ShiftMask,             XK_Return, spawn,          {.v = termcmd } },
        { MODKEY|ShiftMask,             XK_s,      spawn,          {.v = sublime } },
        { MODKEY|ShiftMask,             XK_t,      spawn,          {.v = texstudio } },
        { MODKEY|ShiftMask,             XK_w,      spawn,          {.v = browser } },
        { MODKEY|Mod1Mask,              XK_n,      spawn,          {.v = audacious_next } },
        { MODKEY|Mod1Mask,              XK_t,      spawn,          {.v = audacious_toggle } },
